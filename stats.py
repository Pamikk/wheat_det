...
class kmeans(object):
    ...
    def cal_distance(self,obj1,obj2):
        #dis = ((obj2[:,0]/obj1[0]-1)**2+(obj2[:,1]/obj1[1]-1)**2).reshape(self.k,-1).sum(1)
        dis = cal_iou_distance(obj1,obj2)
        return dis
    ...
    def print_cs(self):
        ...
        dis = 1-self.cal_center_distance(centers,centers)
        print(dis[dis>0.001].mean())
